        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              now = new Date(); // this.expiration = new Date(now.getFullYear()-1, now.getMonth(), now.getDay());
              callback();
...
var S3Proxy = /*#__PURE__*/function () {
  function S3Proxy(config) {
    _classCallCheck(this, S3Proxy);
    AWS.config.update({
  ...
  _createClass(S3Proxy, [{
    key: "enrichObjectContents",
    value: function enrichObjectContents(data) {
    ...
    key: "listObjects",
    value: function () {
      var _listObjects = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(params) {
        var response,
          data,
          _args2 = arguments;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              console.log("listObjects", _args2);
              _context2.prev = 1;
              _context2.next = 4;
            ...
            case 4:
              ...
              console.log("/here");
              data = this.enrichObjectContents(response);
