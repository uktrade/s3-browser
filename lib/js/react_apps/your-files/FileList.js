...
function TableRowBigDataFolder(props) {
  var folderName = (0, _utils.prefixToFolder)(props.folder.Prefix);
  return /*#__PURE__*/_react["default"].createElement("tr", {
    className: "govuk-table__row"
  }, /*#__PURE__*/_react["default"].createElement("td", {
...
function TableRowFolder(props) {
  ...
  return /*#__PURE__*/_react["default"].createElement("tr", {
    ...
    onClick: function onClick() {
      return props.onFolderSelect(folder, !folder.isSelected);
    }
  }, /*#__PURE__*/_react["default"].createElement("td", {
    className: "govuk-table__cell govuk-table__cell--checkbox"
    ...
    onChange: function onChange(e) {
      return props.onFolderSelect(folder, e.target.checked);
    }
...
function TableRowFile(props) {
  ...
  if (file.Key.substr(file.Key.length - 4, file.Key.length) === ".csv") {
    var createTableUrl = "".concat(props.createTableUrl, "?path=").concat(file.Key);
    createTableButton = /*#__PURE__*/_react["default"].createElement("a", {
  ...
  return /*#__PURE__*/_react["default"].createElement("tr", {
    className: "govuk-table__row pointer",
    onClick: function onClick() {
      return props.onFileSelect(file, !file.isSelected);
    }
  }, /*#__PURE__*/_react["default"].createElement("td", {
    className: "govuk-table__cell govuk-table__cell--checkbox"
  }, /*#__PURE__*/_react["default"].createElement("div", {
    ...
    onChange: function onChange(e) {
      return props.onFileSelect(file, e.target.checked);
    }
  }), /*#__PURE__*/_react["default"].createElement("label", {
    className: "govuk-label govuk-checkboxes__label"
  }))))), /*#__PURE__*/_react["default"].createElement("td", {
    ...
    className: "govuk-table__cell"
  }, file.formattedDate.toLocaleString()), /*#__PURE__*/_react["default"].createElement("td", {
    className: "govuk-table__cell"
...
var FileList = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(FileList, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/_react["default"].createElement("thead", null, /*#__PURE__*/_react["default"].createElement(TableHeader, null)), /*#__PURE__*/_react["default"].createElement("tbody", null, folders.map(function (folder) {
        if (folder.isBigData) return /*#__PURE__*/_react["default"].createElement(TableRowBigDataFolder, {
          key: folder.Prefix,
          folder: folder,
          onClick: function onClick() {
            return _this.props.onFolderClick(folder.Prefix);
          }
        });
        if (folder.isSharedFolder) return /*#__PURE__*/_react["default"].createElement(TableRowSharedFolder, {
          key: folder.Prefix,
          folder: folder,
          onClick: function onClick() {
            return _this.props.onFolderClick(folder.Prefix);
          }
        });else return /*#__PURE__*/_react["default"].createElement(TableRowFolder, {
          key: folder.Prefix,
          folder: folder,
          onClick: function onClick() {
            return _this.props.onFolderClick(folder.Prefix);
          },
          onFolderSelect: _this.props.onFolderSelect
        });
      }), files.map(function (file) {
        return /*#__PURE__*/_react["default"].createElement(TableRowFile, {
          key: file.Key,
          file: file,
          createTableUrl: _this.props.createTableUrl,
          onFileClick: function onFileClick() {
            return _this.props.onFileClick(file.Key);
          },
