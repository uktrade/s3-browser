...
_xamzrequire = function () {
  ...
  88: [function (e, t, r) {
    (function (r) {
      ...
      n.Service = s({
        ...
        retryDelays: function retryDelays(e) {
            ...
            if (t < 300) {
              ...
              if (2 === n.HttpClient.streamsApiVersion) {
                if (u) {
                  ...
                  }, p.on("end", h), i.on("error", function (e) {
  ...
  64: [function (e, t, r) {
    function n(e, t) {
      function r(e, t) {
        !0 === t.endpointoperation && h(n, "endpointOperation", c.string.lowerFirst(e));
      }
      var n = this;
      e = e || {}, t = t || {}, t.api = this, e.metadata = e.metadata || {}, h(this, "isApi", !0, !1), h(this, "apiVersion", e.metadata.apiVersion), h(this, "endpointPrefix", e.metadata.endpointPrefix), h(this, "signingName", e.metadata.signingName), h(this, "globalEndpoint", e.metadata.globalEndpoint), h(this, "signatureVersion", e.metadata.signatureVersion), h(this, "jsonVersion", e.metadata.jsonVersion), h(this, "targetPrefix", e.metadata.targetPrefix), h(this, "protocol", e.metadata.protocol), h(this, "timestampFormat", e.metadata.timestampFormat), h(this, "xmlNamespaceUri", e.metadata.xmlNamespace), h(this, "abbreviation", e.metadata.serviceAbbreviation), h(this, "fullName", e.metadata.serviceFullName), h(this, "serviceId", e.metadata.serviceId), l(this, "className", function () {
        ...
        return new o(e, r, t);
      }, c.string.lowerFirst, r)), h(this, "shapes", new i(e.shapes, t, function (e, r) {
        return s.create(r, t);
          ...
          if (o) {
            var s = function () {
              ...
              var l = e("util").inspect(h, !0, null),
                p = "";
              return u && (p += "[33m"), p += "[AWS " + n.service.serviceIdentifier + " " + c, p += " " + a.toString() + "s " + t.retryCount + " retries]", u && (p += "[0;1m"), p += " " + i.util.string.lowerFirst(n.operation), p += "(" + l + ")", u && (p += "[0m"), p;
            }();
  ...
  76: [function (e, t, r) {
    ...
    function a(e) {
      ...
      if (i.payload) {
        ...
        if (o.isEventStream) t = new p(), e.data[payload] = u.createEventStream(2 === AWS.HttpClient.streamsApiVersion ? e.httpResponse.stream : s, t, o);else if ("structure" === o.type || "list" === o.type) {
          var t = new p();
  ...
  75: [function (e, t, r) {
    ...
    function i(e, t, r, n) {
      ...
      if (h.each(r.members, function (e, t) {
        ...
        i += i.indexOf("?") >= 0 ? "&" : "?";
        var a = [];
        h.arrayEach(Object.keys(o).sort(), function (e) {
  ...
  74: [function (e, t, r) {
    function n(e) {
      ...
      r.headers["Content-Type"] = "application/x-www-form-urlencoded; charset=utf-8", r.params = {
        ...
        r.params[e] = t;
      }), r.body = a.queryParamsToString(r.params), h(e);
    }
    function i(e) {
      var t,
  ...
  78: [function (e, t, r) {
    ...
    function s(e, t, r, n) {
      ...
      c.each(t, function (t, o) {
        ...
        u(e + c, t, r.key, n), u(e + h, o, r.value, n);
      });
    }
    function a(e, t, r, n) {
      var o = r.member || {};
  ...
  46: [function (e, t, r) {
    (function (r) {
      ...
      function s(e) {
        ...
        if (!h || 1 !== h.length || "" !== h[0].Address) if (h && h.length > 0) e.httpRequest.updateEndpoint(h[0].Address);else {
          var l = t.makeRequest(r.endpointOperation, {
            Operation: i.name,
            Identifiers: a
          });
          u(l), l.removeListener("validate", d.EventListeners.Core.VALIDATE_PARAMETERS), l.removeListener("retry", d.EventListeners.Core.RETRY_CHECK), d.endpointCache.put(c, [{
            Address: "",
      ...
      function a(e, t) {
        ...
        if (p && 1 === p.length && "" === p[0].Address) return g[l] || (g[l] = []), void g[l].push({
          request: e,
          callback: t
        });
        if (p && p.length > 0) e.httpRequest.updateEndpoint(p[0].Address), t();else {
          var f = r.makeRequest(i.endpointOperation, {
            Operation: s.name,
            Identifiers: c
          });
          f.removeListener("validate", d.EventListeners.Core.VALIDATE_PARAMETERS), u(f), d.endpointCache.put(l, [{
            Address: "",
    ...
    (function (r, n) {
      var i,
        o = {
            ...
            hash: function hash(e, t, r, n) {
              ...
              if (o.isBrowser() && "undefined" != typeof ArrayBuffer && t && t.buffer instanceof ArrayBuffer && (a = !0), n && "object" == _typeof(t) && "function" == typeof t.on && !a) t.on("data", function (e) {
                ...
                h.onerror = function () {
                  ...
                  var e = c + 524288;
                  e > t.size && (e = t.size), h.readAsArrayBuffer(s.call(t, c, e));
                }, h._continueReading();
              }
            },
          ...
          calculateRetryDelay: function calculateRetryDelay(e, t) {
            t || (t = {});
          ...
          getProfilesFromSharedConfig: function getProfilesFromSharedConfig(e, t) {
            ...
            for (var s = e.loadFrom({
              ...
              }), a = 0, u = Object.keys(i); a < u.length; a++) n[u[a]] = i[u[a]];
  ...
  24: [function (e, t, r) {
    function n(e, t, r) {
      ...
      if (null == l || null == p) {
        var f = s();
        null == l && (l = i = [1 | f[0], f[1], f[2], f[3], f[4], f[5]]), null == p && (p = o = 16383 & (f[6] << 8 | f[7]));
      }
      ...
      h[n++] = g >>> 24 & 255, h[n++] = g >>> 16 & 255, h[n++] = g >>> 8 & 255, h[n++] = 255 & g;
      var y = d / 4294967296 * 1e4 & 268435455;
      h[n++] = y >>> 8 & 255, h[n++] = 255 & y, h[n++] = y >>> 24 & 15 | 16, h[n++] = y >>> 16 & 255, h[n++] = p >>> 8 | 128, h[n++] = 255 & p;
  ...
  20: [function (e, t, r) {
    (function (t, n) {
      ...
      r.debuglog = function (e) {
        ...
        date: "magenta",
        regexp: "red"
      }, r.isArray = d, r.isBoolean = m, r.isNull = v, r.isNullOrUndefined = g, r.isNumber = y, r.isString = b, r.isSymbol = w, r.isUndefined = E, r.isRegExp = _, r.isObject = S, r.isDate = C, r.isError = x, r.isFunction = R, r.isPrimitive = A, r.isBuffer = e("./support/isBuffer");
    ...
    !function (e) {
      ...
      c.prototype = {
        tokenize: function tokenize(e) {
          ...
          } else if (void 0 !== R[e[this._current]]) t.push(this._consumeOperator(e));else if (void 0 !== A[e[this._current]]) this._current++;else if ("&" === e[this._current]) r = this._current, this._current++, "&" === e[this._current] ? (this._current++, t.push({
            type: "And",
            value: "&&",
            start: r
          })) : t.push({
      ...
      T.EOF = 0, T.UnquotedIdentifier = 0, T.QuotedIdentifier = 0, T.Rbracket = 0, T.Rparen = 0, T.Comma = 0, T.Rbrace = 0, T.Number = 0, T.Current = 0, T.Expref = 0, T.Pipe = 1, T.Or = 2, T.And = 3, T.EQ = 5, T.GT = 5, T.LT = 5, T.GTE = 5, T.LTE = 5, T.NE = 5, T.Flatten = 9, T.Star = 20, T.Filter = 21, T.Dot = 40, T.Not = 45, T.Lbrace = 50, T.Lbracket = 55, T.Lparen = 60, h.prototype = {
        ...
        visit: function visit(e, s) {
          ...
          switch (e.type) {
            ...
            case "AndExpression":
              return h = this.visit(e.children[0], s), !0 === i(h) ? h : this.visit(e.children[1], s);
            case "NotExpression":
              return h = this.visit(e.children[0], s), i(h);
            case "Literal":
              return e.value;
            case "Pipe":
              return f = this.visit(e.children[0], s), this.visit(e.children[1], f);
    ...
    e("../http"), n.XHRClient = n.util.inherit({
      handleRequest: function handleRequest(e, t, r, o) {
        ...
        e.stream = h, h.addEventListener("readystatechange", function () {
          ...
          this.readyState >= this.HEADERS_RECEIVED && !l && (u.statusCode = h.status, u.headers = s.parseHeaders(h.getAllResponseHeaders()), u.emit("headers", u.statusCode, u.headers, h.statusText), l = !0), this.readyState === this.DONE && s.finishRequest(h, u);
  ...
  34: [function (e, t, r) {
    ...
    t.exports = n, n.BLOCK_SIZE = 64, n.prototype.update = function (e) {
      ...
      for (var e = this, t = e.buffer, r = e.state, n = r[0], i = r[1], o = r[2], a = r[3], u = r[4], c = r[5], h = r[6], l = r[7], p = 0; p < 64; p++) {
        if (p < 16) this.temp[p] = (255 & t[4 * p]) << 24 | (255 & t[4 * p + 1]) << 16 | (255 & t[4 * p + 2]) << 8 | 255 & t[4 * p + 3];else {
          var f = this.temp[p - 2],
        ...
        l = h, h = c, c = u, u = a + v | 0, a = o, o = i, i = n, n = v + g | 0;
      }
      r[0] += n, r[1] += i, r[2] += o, r[3] += a, r[4] += u, r[5] += c, r[6] += h, r[7] += l;
    };
  }, {
    "./browserHashUtils": 30,
    "buffer/": 3
  ...
  32: [function (e, t, r) {
    ...
    t.exports = n, n.BLOCK_SIZE = l, n.prototype.update = function (e) {
      ...
      if (!this.finished) {
        ...
        r.setUint32(l - 8, o >>> 0, !0), r.setUint32(l - 4, Math.floor(o / 4294967296), !0), this.hashBuffer(), this.finished = !0;
      }
  ...
  17: [function (e, t, r) {
    ...
    n.prototype.parse = function (e, t, r) {
      ...
      if (!_[o]) for (var c = 0, R = g.length; c < R; c++) {
        var j = g[c],
      ...
      var H = n.indexOf("?");
      if (-1 !== H ? (this.search = n.substr(H), this.query = n.substr(H + 1), t && (this.query = x.parse(this.query)), n = n.slice(0, H)) : t && (this.search = "", this.query = {}), n && (this.pathname = n), C[o] && this.hostname && !this.pathname && (this.pathname = "/"), this.pathname || this.search) {
        var D = this.pathname || "",
          N = this.search || "";
        this.path = D + N;
      }
      ...
      var t = this.protocol || "",
        ...
        i = !1,
        o = "";
      this.host ? i = e + this.host : this.hostname && (i = e + (-1 === this.hostname.indexOf(":") ? this.hostname : "[" + this.hostname + "]"), this.port && (i += ":" + this.port)), this.query && c(this.query) && Object.keys(this.query).length && (o = x.stringify(this.query));
      ...
      if (e.protocol && e.protocol !== r.protocol) {
        ...
        if (r.protocol = e.protocol, e.host || S[e.protocol]) r.pathname = e.pathname;else {
    ...
    t.exports = function (e, t, r, i) {
      ...
      for (var c = 0; c < u; ++c) {
        var h,
          ...
          d = e[c].replace(s, "%20"),
          m = d.indexOf(r);
        m >= 0 ? (h = d.substr(0, m), l = d.substr(m + 1)) : (h = d, l = ""), p = decodeURIComponent(h), f = decodeURIComponent(l), n(o, p) ? Array.isArray(o[p]) ? o[p].push(f) : o[p] = [o[p], f] : o[p] = f;
      }
      return o;
    };
  }, {}],
    ...
    t.exports = function (e, t, r, o) {
      ...
      for (var h = 0; h < c; ++h) {
        var l,
          ...
          m = e[h].replace(a, "%20"),
          v = m.indexOf(r);
        v >= 0 ? (l = m.substr(0, v), p = m.substr(v + 1)) : (l = m, p = ""), f = decodeURIComponent(l), d = decodeURIComponent(p), n(s, f) ? i(s[f]) ? s[f].push(d) : s[f] = [s[f], d] : s[f] = d;
      }
      return s;
    };
    ...
    (function (e) {
      !function (n) {
        ...
        function p(e) {
          ...
          for (o = r > 0 ? r + 1 : 0; o < v;) {
            for (s = g, a = 1, h = _; o >= v && i("invalid-input"), p = c(e.charCodeAt(o++)), (p >= _ || p > U((E - g) / a)) && i("overflow"), g += p * a, f = h <= b ? S : h >= b + C ? C : h - b, !(p < f); h += _) d = _ - f, a > U(E / d) && i("overflow"), a *= d;
            t = m.length + 1, b = l(g - s, t, 0 == s), U(g / t) > E - y && i("overflow"), y += U(g / t), g %= t, m.splice(g++, 0, y);
          }
          return u(m);
        }
        function f(e) {
          ...
          for (n = o = w.length, o && w.push(k); n < v;) {
            ...
            for (g = n + 1, c - t > U((E - r) / g) && i("overflow"), r += (c - t) * g, t = c, u = 0; u < v; ++u) if (m = e[u], m < t && ++r > E && i("overflow"), m == t) {
              for (p = r, f = _; d = f <= s ? S : f >= s + C ? C : f - s, !(p < d); f += _) b = p - d, y = _ - d, w.push(N(h(d + b % y, 0))), p = U(b / y);
              w.push(N(h(p, 0))), s = l(r, g, n == o), r = 0, ++n;
            }
            ++r, ++t;
          }
          return w.join("");
  ...
  3: [function (e, t, r) {
    (function (t, n) {
      ...
      function p(e, t, r, i) {
        ...
        return t = void 0 === r && void 0 === i ? new Uint8Array(t) : void 0 === i ? new Uint8Array(t, r) : new Uint8Array(t, r, i), n.TYPED_ARRAY_SUPPORT ? (e = t, e.__proto__ = n.prototype) : e = l(e, t), e;
      }
      function f(e, t) {
        if (n.isBuffer(t)) {
          var r = 0 | d(t.length);
      ...
      function w(e, t, r, n, i) {
        ...
        if (i) {
          ...
          for (var l = !0, p = 0; p < u; p++) if (o(e, c + p) !== o(t, p)) {
            l = !1;
            break;
          }
          if (l) return c;
          ...
          if (i + a <= r) {
            ...
            switch (a) {
              ...
              case 2:
                ...
                break;
              case 3:
                u = e[i + 1], c = e[i + 2], 128 == (192 & u) && 128 == (192 & c) && (l = (15 & o) << 12 | (63 & u) << 6 | 63 & c) > 2047 && (l < 55296 || l > 57343) && (s = l);
                break;
              case 4:
                u = e[i + 1], c = e[i + 2], h = e[i + 3], 128 == (192 & u) && 128 == (192 & c) && 128 == (192 & h) && (l = (15 & o) << 18 | (63 & u) << 12 | (63 & c) << 6 | 63 & h) > 65535 && l < 1114112 && (s = l);
            }
          }
      ...
      r.Buffer = n, r.SlowBuffer = m, r.INSPECT_MAX_BYTES = 50, n.TYPED_ARRAY_SUPPORT = void 0 !== t.TYPED_ARRAY_SUPPORT ? t.TYPED_ARRAY_SUPPORT : function () {
        ...
        if (e === t) return 0;
        for (var r = e.length, i = t.length, o = 0, s = Math.min(r, i); o < s; ++o) if (e[o] !== t[o]) {
          r = e[o], i = t[o];
          break;
        }
        ...
        for (var s = o - i, a = r - t, u = Math.min(s, a), c = this.slice(i, o), h = e.slice(t, r), l = 0; l < u; ++l) if (c[l] !== h[l]) {
          s = c[l], a = h[l];
          break;
        }
      ...
      n.prototype.slice = function (e, t) {
        ...
        return e = +e, t |= 0, r || U(this, e, t, 4, 4294967295, 0), n.TYPED_ARRAY_SUPPORT ? (this[t + 3] = e >>> 24, this[t + 2] = e >>> 16, this[t + 1] = e >>> 8, this[t] = 255 & e) : D(this, e, t, !0), t + 4;
      }, n.prototype.writeUInt32BE = function (e, t, r) {
        return e = +e, t |= 0, r || U(this, e, t, 4, 4294967295, 0), n.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e) : D(this, e, t, !1), t + 4;
        ...
        return e = +e, t |= 0, r || U(this, e, t, 4, 2147483647, -2147483648), n.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8, this[t + 2] = e >>> 16, this[t + 3] = e >>> 24) : D(this, e, t, !0), t + 4;
      }, n.prototype.writeInt32BE = function (e, t, r) {
        return e = +e, t |= 0, r || U(this, e, t, 4, 2147483647, -2147483648), e < 0 && (e = 4294967295 + e + 1), n.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e) : D(this, e, t, !1), t + 4;
        ...
        var o,
          s = i - r;
        if (this === e && r < t && t < i) for (o = s - 1; o >= 0; --o) e[o + t] = this[o + r];else if (s < 1e3 || !n.TYPED_ARRAY_SUPPORT) for (o = 0; o < s; ++o) e[o + t] = this[o + r];else Uint8Array.prototype.set.call(e, this.subarray(r, r + s), t);
        return s;
  ...
  1: [function (e, t, r) {
    ...
    function s(e) {
      var t,
        ...
        c = 0,
        h = a > 0 ? s - 4 : s;
      for (r = 0; r < h; r += 4) t = l[e.charCodeAt(r)] << 18 | l[e.charCodeAt(r + 1)] << 12 | l[e.charCodeAt(r + 2)] << 6 | l[e.charCodeAt(r + 3)], u[c++] = t >> 16 & 255, u[c++] = t >> 8 & 255, u[c++] = 255 & t;
      return 2 === a && (t = l[e.charCodeAt(r)] << 2 | l[e.charCodeAt(r + 1)] >> 4, u[c++] = 255 & t), 1 === a && (t = l[e.charCodeAt(r)] << 10 | l[e.charCodeAt(r + 1)] << 4 | l[e.charCodeAt(r + 2)] >> 2, u[c++] = t >> 8 & 255, u[c++] = 255 & t), u;
    }
    function a(e) {
    ...
    for (var h = [], l = [], p = "undefined" != typeof Uint8Array ? Uint8Array : Array, f = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", d = 0, m = f.length; d < m; ++d) h[d] = f[d], l[f.charCodeAt(d)] = d;
    l["-".charCodeAt(0)] = 62, l["_".charCodeAt(0)] = 63;
  }, {}]
}, {}, [28]);
AWS.apiLoader.services.s3 = {}, AWS.S3 = AWS.Service.defineService("s3", ["2006-03-01"]), _xamzrequire = function e(t, r, i) {
  function n(o, s) {
    if (!r[o]) {
      if (!t[o]) {
        var u = "function" == typeof _xamzrequire && _xamzrequire;
  ...
  for (var a = "function" == typeof _xamzrequire && _xamzrequire, o = 0; o < i.length; o++) n(i[o]);
  return n;
}({
  102: [function (e, t, r) {
    var i = e("../core"),
    ...
    i.util.update(i.S3.prototype, {
      getSignatureVersion: function getSignatureVersion(e) {
      ...
      validateBucketEndpoint: function validateBucketEndpoint(e) {
      ...
      validateBucketName: function validateBucketName(e) {
        var t = e.service,
          r = t.getSignatureVersion(e),
          n = e.params && e.params.Bucket,
          a = e.params && e.params.Key,
          o = n && n.indexOf("/");
        if (n && o >= 0) if ("string" == typeof a && o > 0) {
      ...
      isValidAccelerateOperation: function isValidAccelerateOperation(e) {
        return -1 === ["createBucket", "deleteBucket", "listBuckets"].indexOf(e);
      },
      populateURI: function populateURI(e) {
        var t = e.httpRequest,
          r = e.params.Bucket,
          i = e.service,
          n = t.endpoint;
        if (r && !i.pathStyleBucketName(r)) {
          ...
          var a = n.port;
          n.host = 80 !== a && 443 !== a ? n.hostname + ":" + n.port : n.hostname, t.virtualHostedBucket = r, i.removeVirtualHostedBucketFromPath(e);
        }
      },
      removeVirtualHostedBucketFromPath: function removeVirtualHostedBucketFromPath(e) {
        var t = e.httpRequest,
          r = t.virtualHostedBucket;
        if (r && t.path) {
          if (e.params && e.params.Key) {
            var n = "/" + i.util.uriEscapePath(e.params.Key);
            if (0 === t.path.indexOf(n) && (t.path.length === n.length || "?" === t.path[n.length])) return;
          }
          t.path = t.path.replace(new RegExp("/" + r), ""), "/" !== t.path[0] && (t.path = "/" + t.path);
        }
      },
      addExpect100Continue: function addExpect100Continue(e) {
        var t = e.httpRequest.headers["Content-Length"];
        i.util.isNode() && (t >= 1048576 || e.params.Body instanceof i.util.stream.Stream) && (e.httpRequest.headers.Expect = "100-continue");
      },
      addContentType: function addContentType(e) {
        var t = e.httpRequest;
      ...
      willComputeChecksums: function willComputeChecksums(e) {
      ...
      pathStyleBucketName: function pathStyleBucketName(e) {
      ...
      dnsCompatibleBucketName: function dnsCompatibleBucketName(e) {
        var t = e,
      ...
      retryableError: function retryableError(e, t) {
      ...
      updateReqBucketRegion: function updateReqBucketRegion(e, t) {
        var r = e.httpRequest;
        if ("string" == typeof t && t.length && (r.region = t), r.endpoint.host.match(/s3(?!-accelerate).*\.amazonaws\.com$/)) {
          ...
          var s = i.util.copy(a);
          delete s.endpoint, s.region = r.region, r.endpoint = new i.S3(s).endpoint, n.populateURI(e), a.s3BucketEndpoint = o, r.headers.Host = r.endpoint.host, "validate" === e._asm.currentState && (e.removeListener("build", n.populateURI), e.addListener("build", n.removeVirtualHostedBucketFromPath));
        }
      },
      extractData: function extractData(e) {
        var t = e.request;
      ...
      extractError: function extractError(e) {
        var t = {
            304: "NotModified",
            403: "Forbidden",
            400: "BadRequest",
        ...
        s && u && s !== c[u] && (c[u] = s);
        var l;
        if (t[n] && 0 === a.length) u && !s && (l = c[u] || null) !== r.httpRequest.region && (s = l), e.error = i.util.error(new Error(), {
          code: t[n],
          message: null,
          region: s
        });else {
          var p = new i.XML.Parser().parse(a.toString());
          p.Region && !s ? (s = p.Region, u && s !== c[u] && (c[u] = s)) : !u || s || p.Region || (l = c[u] || null) !== r.httpRequest.region && (s = l), e.error = i.util.error(new Error(), {
            code: p.Code || n,
      ...
      requestBucketRegion: function requestBucketRegion(e, t) {
        var r = e.error,
          n = e.request,
        ...
        var c = n.service[s](u);
        c._requestRegionForBucket = a, c.send(function () {
          var e = n.service.bucketRegionCache[a] || null;
          r.region = e, t();
        });
      },
      reqRegionForNetworkingError: function reqRegionForNetworkingError(e, t) {
        ...
        var o = n.service,
          ...
          u = s[a] || null;
        if (u && u !== n.httpRequest.region) o.updateReqBucketRegion(n, u), t();else if (o.dnsCompatibleBucketName(a)) {
          if (n.httpRequest.virtualHostedBucket) {
            var c = o.listObjects({
              Bucket: a,
              MaxKeys: 0
            });
            o.updateReqBucketRegion(c, "us-east-1"), c._requestRegionForBucket = a, c.send(function () {
              var e = o.bucketRegionCache[a] || null;
              e && e !== n.httpRequest.region && o.updateReqBucketRegion(n, e), t();
            });
          } else t();
        } else o.updateReqBucketRegion(n, "us-east-1"), "us-east-1" !== s[a] && (s[a] = "us-east-1"), t();
      },
      bucketRegionCache: {},
      clearBucketRegionCache: function clearBucketRegionCache(e) {
        var t = this.bucketRegionCache;
        e ? "string" == typeof e && (e = [e]) : e = Object.keys(t);
        for (var r = 0; r < e.length; r++) delete t[e[r]];
        return t;
      },
      correctBucketRegionFromCache: function correctBucketRegionFromCache(e) {
      ...
      extractRequestIds: function extractRequestIds(e) {
      ...
      getSignedUrl: function getSignedUrl(e, t, r) {
        t = i.util.copy(t || {});
        var n = t.Expires || 900;
        if ("number" != typeof n) throw i.util.error(new Error(), {
          code: "InvalidParameterException",
          message: "The expiration must be a number, received " + _typeof(n)
        });
        delete t.Expires;
      ...
      createPresignedPost: function createPresignedPost(e, t) {
        function r() {
          return {
        ...
        "function" == typeof e && void 0 === t && (t = e, e = null), e = i.util.copy(e || {});
      ...
      preparePostFields: function preparePostFields(e, t, r, a, o, s) {
        ...
        var c = i.util.date.iso8601(u).replace(/[:\-]|\.\d{3}/g, ""),
          ...
          d = e.accessKeyId + "/" + p;
        a.bucket = r, a["X-Amz-Algorithm"] = "AWS4-HMAC-SHA256", a["X-Amz-Credential"] = d, a["X-Amz-Date"] = c, e.sessionToken && (a["X-Amz-Security-Token"] = e.sessionToken);
        for (var f in a) if (a.hasOwnProperty(f)) {
          var h = {};
          h[f] = a[f], o.push(h);
        }
        return a.Policy = this.preparePostPolicy(new Date(u.valueOf() + 1e3 * s), o), a["X-Amz-Signature"] = i.util.crypto.hmac(n.getSigningKey(e, l, t, "s3", !0), a.Policy, "hex"), a;
      },
      preparePostPolicy: function preparePostPolicy(e, t) {
        return i.util.base64.encode(JSON.stringify({
          expiration: i.util.date.iso8601(e),
          conditions: t
        }));
      },
      prepareSignedUrl: function prepareSignedUrl(e) {
        e.addListener("validate", e.service.noPresignedContentLength), e.removeListener("build", e.service.addContentType), e.params.Body ? e.addListener("afterBuild", i.EventListeners.Core.COMPUTE_SHA256) : e.removeListener("build", e.service.computeContentMd5);
      },
      disableBodySigning: function disableBodySigning(e) {
      ...
      noPresignedContentLength: function noPresignedContentLength(e) {
        if (void 0 !== e.params.ContentLength) throw i.util.error(new Error(), {
          code: "UnexpectedParameter",
          message: "ContentLength is not supported in pre-signed URLs."
        });
      },
      createBucket: function createBucket(e, t) {
      ...
      upload: function upload(e, t, r) {
        "function" == typeof t && void 0 === r && (r = t, t = null), t = t || {}, t = i.util.merge(t || {}, {
          service: this,
          params: e
        });
  ...
  86: [function (e, t, r) {
    ...
    i.S3.ManagedUpload = i.util.inherit({
      constructor: function constructor(e) {
        var t = this;
        i.SequentialExecutor.call(t), t.body = null, t.sliceFn = null, t.callback = null, t.parts = {}, t.completeInfo = [], t.fillQueue = function () {
          t.callback(new Error("Unsupported body payload " + _typeof(t.body)));
        }, t.configure(e);
      },
      configure: function configure(e) {
        if (e = e || {}, this.partSize = this.minPartSize, e.queueSize && (this.queueSize = e.queueSize), e.partSize && (this.partSize = e.partSize), e.leavePartsOnError && (this.leavePartsOnError = !0), e.tags) {
          if (!Array.isArray(e.tags)) throw new Error("Tags must be specified as an array; " + _typeof(e.tags) + " provided.");
          this.tags = e.tags;
        }
      ...
      send: function send(e) {
        ...
        var r = !0;
        if (t.sliceFn) t.fillQueue = t.fillBuffer;else if (i.util.isNode()) {
          var n = i.util.stream.Stream;
          t.body instanceof n && (r = !1, t.fillQueue = t.fillStream, t.partBuffers = [], t.body.on("error", function (e) {
            t.cleanup(e);
      ...
      abort: function abort() {
        var e = this;
        !0 === e.isDoneChunking && 1 === e.totalPartNumbers && e.singlePart ? e.singlePart.abort() : e.cleanup(i.util.error(new Error("Request aborted by user"), {
          code: "RequestAbortedError",
          retryable: !1
        }));
      },
      validateBody: function validateBody() {
        var e = this;
        if (e.body = e.service.config.params.Body, "string" == typeof e.body) e.body = i.util.buffer.toBuffer(e.body);else if (!e.body) throw new Error("params.Body is required");
        e.sliceFn = i.util.arraySliceFn(e.body);
      },
      bindServiceObject: function bindServiceObject(e) {
        e = e || {};
        var t = this;
        if (t.service) {
          var r = t.service,
            n = i.util.copy(r.config);
          n.signatureVersion = r.getSignatureVersion(), t.service = new r.constructor.__super__(n), t.service.config.params = i.util.merge(t.service.config.params || {}, e);
      ...
      fillBuffer: function fillBuffer() {
        ...
        for (; e.activeParts < e.queueSize && e.partPos < t;) {
          ...
          e.partPos += e.partSize, (n(i) < e.partSize || e.partPos === t) && (e.isDoneChunking = !0, e.numParts = e.totalPartNumbers + 1), e.nextChunk(i);
        }
      },
        ...
        if (!(e.activeParts >= e.queueSize)) {
          ...
          if (t && (e.partBuffers.push(t), e.partBufferLength += t.length, e.totalChunkedBytes += t.length), e.partBufferLength >= e.partSize) {
            ...
            if (e.partBuffers = [], e.partBufferLength = 0, r.length > e.partSize) {
              ...
              e.partBuffers.push(i), e.partBufferLength += i.length, r = r.slice(0, e.partSize);
            }
            e.nextChunk(r);
          }
          e.isDoneChunking && !e.isDoneSending && (r = 1 === e.partBuffers.length ? e.partBuffers[0] : a.concat(e.partBuffers), e.partBuffers = [], e.partBufferLength = 0, e.totalBytes = e.totalChunkedBytes, e.isDoneSending = !0, (0 === e.numParts || r.length > 0) && (e.numParts++, e.nextChunk(r))), e.body.read(0);
        }
      },
      nextChunk: function nextChunk(e) {
        var t = this;
        ...
        if (t.isDoneChunking && 1 === r) {
          ...
          return a._managedUpload = t, a.on("httpUploadProgress", t.progress).send(t.finishSinglePart), t.singlePart = a, null;
        }
      ...
      uploadPart: function uploadPart(e, t) {
        var r = this,
          n = {
            Body: e,
        ...
        r.parts[t] = o, o._lastUploadedBytes = 0, o._managedUpload = r, o.on("httpUploadProgress", r.progress), o.send(function (e, o) {
          if (delete r.parts[n.PartNumber], r.activeParts--, !(e || o && o.ETag)) {
            var s = "No access to ETag property on response.";
            i.util.isBrowser() && (s += " Check CORS configuration to expose ETag header."), e = i.util.error(new Error(s), {
              code: "ETagMissing",
              retryable: !1
            });
          }
      ...
      queueChunks: function queueChunks(e, t) {
        var r = this;
      ...
      finishSinglePart: function finishSinglePart(e, t) {
        var r = this.request._managedUpload,
          i = this.request.httpRequest,
          n = i.endpoint;
        if (e) return r.callback(e);
        t.Location = [n.protocol, "//", n.host, i.path].join(""), t.key = this.request.params.Key, t.Key = this.request.params.Key, t.Bucket = this.request.params.Bucket, r.callback(e, t);
      },
    ...
    }), i.util.mixin(i.S3.ManagedUpload, i.SequentialExecutor), i.S3.ManagedUpload.addPromisesToClass = function (e) {
      this.prototype.promise = i.util.promisifyMethod("send", e);
    }, i.S3.ManagedUpload.deletePromisesFromClass = function () {
      delete this.prototype.promise;
    }, i.util.addPromises(i.S3.ManagedUpload), t.exports = i.S3.ManagedUpload;
  }, {
    "../core": 38
  }]
}, {}, [102]);
...
AWS.apiLoader.services.sts = {}, AWS.STS = AWS.Service.defineService("sts", ["2011-06-15"]), _xamzrequire = function e(r, t, n) {
  ...
  105: [function (e, r, t) {
    ...
    n.util.update(n.STS.prototype, {
      credentialsFrom: function credentialsFrom(e, r) {
      ...
      assumeRoleWithWebIdentity: function assumeRoleWithWebIdentity(e, r) {
        return this.makeUnauthenticatedRequest("assumeRoleWithWebIdentity", e, r);
      },
      assumeRoleWithSAML: function assumeRoleWithSAML(e, r) {
